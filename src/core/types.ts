...
export const IPC_CHANNELS = {
  ...
  GET_FAST_RELAY_SETTINGS: 'settings:getFastRelaySettings',
  SET_FAST_RELAY_SETTINGS: 'settings:setFastRelaySettings',
  TEST_FAST_RELAY_NODES: 'settings:testFastRelayNodes',
