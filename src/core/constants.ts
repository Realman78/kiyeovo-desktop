 ...
 *
 * No-bridge rule:
 * Data keys/topics/protocol IDs are mode-scoped. A value produced in one mode
 * must never be read/written in the other mode.
 */
...
export const MAX_MESSAGES_PER_STORE = 40;
export const OFFLINE_CONTROL_MESSAGE_RESERVE = 10;
export const MESSAGE_TTL = 7 * 24 * 60 * 60 * 1000;
export const OFFLINE_MESSAGE_MAX_FUTURE_SKEW_MS = 2 * 60 * 1000; // 2 minutes
export const OFFLINE_ACK_MAX_FUTURE_SKEW_MS = 10 * 60 * 1000; // 10 minutes
...
export const GROUP_PENDING_ACK_RETIRE_AGE_MS = 14 * 24 * 60 * 60 * 1000; // 14 days
...
export const MAX_BOOTSTRAP_NODES_FAST = 3;
export const MAX_BOOTSTRAP_NODES_TOR = 2;
