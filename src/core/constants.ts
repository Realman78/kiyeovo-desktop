...
export const MAX_KEY_EXCHANGE_AGE = 2 * 60 * 1000;     // 2 minutes
...
export const PENDING_KEY_EXCHANGE_EXPIRATION = 2 * 60 * 1000; // 2 minutes
export const FILE_ACCEPTANCE_TIMEOUT = 30 * 1000;
